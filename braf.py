...
def main():
    ...
    parser.add_argument("--sample-size", default=1.0, help="Sample size for random forest")
    parser.add_argument("--p_critical", default=0.5, help="Percentage of forest size using critical set")
